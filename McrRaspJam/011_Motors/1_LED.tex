...
\label{sec:LED}
	...
	\subsection{Setting up the circuit}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.75\linewidth]{McrRaspJam/011_Motors/1_LED/breadboard_underside}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.5\linewidth]{McrRaspJam/011_Motors/1_LED/schematic_LED_3}

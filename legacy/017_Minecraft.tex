...
\begin{document}
	...
	\input{McrRaspJam/017_Minecraft/0_introduction}
		\clearpage
		
	\input{McrRaspJam/017_Minecraft/1_hellominecraft}
		\webclearpage
		
	\input{McrRaspJam/017_Minecraft/2_loops}
		\webclearpage
	
	\input{McrRaspJam/017_Minecraft/3_TNT}
	\webclearpage

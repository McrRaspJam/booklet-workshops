\section{The Motor Circuit}
	...
	\subsection{Setting up a Motor Circuit}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=0.6\linewidth]{sections/2_motor/schematic_3}
	...
	\subsection{Programming the Motor}
		...
		\lstinputlisting[style=Python, lastline=6]{sections/2_motor/1_Motor.py}
		
		This time, we will set up all three of the GPIO pins that we connected:
	
		\lstinputlisting[style=Python, firstline=7, firstnumber=7, lastline=15]{sections/2_motor/1_Motor.py}
		...
		\lstinputlisting[style=Python, firstline=16, firstnumber=16, lastline=20]{sections/2_motor/1_Motor.py}
		...
		\lstinputlisting[style=Python, firstline=21, firstnumber=21, lastline=26]{sections/2_motor/1_Motor.py}
		...
		\subsubsection*{Reverse Gear}
			...
			\lstinputlisting[style=Python, firstline=21, firstnumber=21, lastline=38]{sections/2_motor/2_Motor.py}
